...
namespace YdService.Db
{
    ...
    public class SqlHelper
    {
        ...
        /// </summary>
        /// 
        private readonly static string ip = ConfigurationManager.AppSettings["dbIp"].Trim().ToString();
        private readonly static string user = ConfigurationManager.AppSettings["dbUser"].Trim().ToString();
        private readonly static string passwd = ConfigurationManager.AppSettings["dbPasswd"].Trim().ToString();
        ...
        {
            connectionString = "Data Source=" + ip + ";Initial Catalog=" + db + ";Persist Security Info=True;User ID=" + user + ";Password=" + passwd + ";";
        }
